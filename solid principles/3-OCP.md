...
#### **لماذا يهم OCP؟**
تخيل أن لديك تطبيقًا يدير طرق دفع مختلفة (مثل بطاقة ائتمان أو PayPal). إذا كنت تضيف طريقة دفع جديدة (مثل Apple Pay) وتحتاج إلى تعديل الكلاس الأصلي في كل مرة، فقد تُدخل أخطاء أو تكسر وظائف موجودة. باتباع OCP، يمكنك تصميم الكود بحيث يسمح بإضافة طرق دفع جديدة دون لمس الكود الأصلي.
